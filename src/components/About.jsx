            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  ...
                  Today, we are proud to offer a comprehensive range of security
                  manpower solutions delivered by highly trained personnel who
                  share our dedication to quality service.
                </p>
                <p className="text-lg text-muted-foreground">
                  ...
                  safe, confident, and free to focus on what matters most to
                  them. This belief drives everything we do, from the rigorous
                  training of our staff to the personalized service we provide
                  to each client.
                </p>
              </div>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-red-200 p-8 rounded-lg shadow-lg">
                ...
                <p className="text-muted-foreground">
                  To be the most trusted and respected security manpower
                  provider, recognized for our exceptional service, innovative
                  solutions, and the positive impact we make on the safety and
              ...
              <div className="bg-red-200 p-8 rounded-lg shadow-lg">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-primary shrink-0" />
                    <span>
                      Innovation in our approach to security challenges
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  At SecureForce, we follow a systematic approach to security
                  that ensures we deliver tailored, effective solutions for each
                  client. Our methodology combines thorough assessment,
                  strategic planning, professional execution, and continuous
                  improvement.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        We begin by thoroughly understanding your security
                        needs, risks, and objectives through detailed
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        We continuously monitor performance, gather feedback,
                        and make adjustments to ensure optimal security
                        outcomes.
                      </p>
                    </div>
                  </div>
