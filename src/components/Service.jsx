        ...
        <section className="relative bg-slate-900 text-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 md:py-24 flex flex-col items-center text-center">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-2xl text-slate-200">
              Comprehensive security manpower solutions tailored to your
              specific needs
            </p>
          </div>
        </section>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Protection for apartments, gated communities, and
                        private residences
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Security for office buildings, retail stores, and
                        business premises
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  and order in various settings. They are reliable, efficient,
                  and committed to providing high-quality service that meets
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Pre and post-event cleaning services for venues and
                        event spaces
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  ...
                  security presence at events, clubs, and venues, ensuring a
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Entrance control and internal security for clubs and
                        bars
                      </p>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Our pantry services provide seamless support for your
                  workplace or residence, ensuring a clean, organized, and
                  welcoming environment with refreshments, supplies, and
                  attentive service.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Supplying and managing beverages and snacks for staff
                        and visitors.
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Comprehensive security planning and personnel for events of
                  all sizes, from corporate functions to large public
                  gatherings.
                </p>
